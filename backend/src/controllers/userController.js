    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                if (user) {
                    return [2 /*return*/, res.status(400).json({
                            msg: "El usuario ".concat(email, " ya existe")
                        })];
                }
            ...
            case 4:
                _b.sent();
                res.json({
                    msg: "Uruario ".concat(name, " creado exitosamente!"),
                });
                return [3 /*break*/, 6];
            case 5:
                error_1 = _b.sent();
...
var loginUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, passwordValid, token;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                ...
                if (!user) {
                    return [2 /*return*/, res.status(400).json({
                            msg: "El usuario ".concat(email, " no existe")
                        })];
                }
